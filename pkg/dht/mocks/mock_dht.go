...
// Source: czarcoin.org/czarcoin/pkg/dht (interfaces: DHT,RoutingTable)
...
func (m *MockDHT) FindNode(arg0 context.Context, arg1 czarcoin.NodeID) (pb.Node, error) {
...
func (m *MockDHT) GetNodes(arg0 context.Context, arg1 czarcoin.NodeID, arg2 int, arg3 ...pb.Restriction) ([]*pb.Node, error) {
...
func (m *MockRoutingTable) FindNear(arg0 czarcoin.NodeID, arg1 int) ([]*pb.Node, error) {
...
func (m *MockRoutingTable) GetBucket(arg0 czarcoin.NodeID) (dht.Bucket, bool) {
