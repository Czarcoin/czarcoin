...
import (
	...
	x "czarcoin.org/czarcoin/pkg/overlay"
...
func (m *MockClient) Lookup(ctx context.Context, nodeID czarcoin.NodeID) (*pb.Node, error) {
...
func (m *MockClient) BulkLookup(ctx context.Context, nodeIDs czarcoin.NodeIDList) ([]*pb.Node, error) {
