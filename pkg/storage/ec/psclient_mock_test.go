...
// Source: czarcoin.org/czarcoin/pkg/piecestore/rpc/client (interfaces: Client)

// mockgen -destination=pkg/storage/ec/psclient_mock_test.go czarcoin.org/czarcoin/pkg/piecestore/rpc/client Client
